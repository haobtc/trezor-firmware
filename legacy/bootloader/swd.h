...
#define SWD_DP_CTRLSTAT_ORUNDETECT           ((unsigned int)1 << SWD_DP_CTRLSTAT_ORUNDETECT_BITNUM)
#define SWD_DP_CTRLSTAT_STICKYORUN           ((unsigned int)1 << SWD_DP_CTRLSTAT_STICKYORUN_BITNUM)
#define SWD_DP_CTRLSTAT_TRNMODE              ((unsigned int)3 << SWD_DP_CTRLSTAT_TRNMODE_BITNUM)
#define SWD_DP_CTRLSTAT_STICKYCMP            ((unsigned int)1 << SWD_DP_CTRLSTAT_STICKYCMP_BITNUM)
#define SWD_DP_CTRLSTAT_STICKYERR            ((unsigned int)1 << SWD_DP_CTRLSTAT_STICKYERR_BITNUM)
#define SWD_DP_CTRLSTAT_READOK               ((unsigned int)1 << SWD_DP_CTRLSTAT_READOK_BITNUM)
#define SWD_DP_CTRLSTAT_WDATAERR             ((unsigned int)1 << SWD_DP_CTRLSTAT_WDATAERR_BITNUM)
#define SWD_DP_CTRLSTAT_MASKLANE             ((unsigned int)0x0F << SWD_DP_CTRLSTAT_MASKLANE_BITNUM)
#define SWD_DP_CTRLSTAT_TRNCNT               ((unsigned int)0x0FFF << SWD_DP_CTRLSTAT_TRNCNT_BITNUM)
#define SWD_DP_CTRLSTAT_CDBGRSTREQ           ((unsigned int)1 << SWD_DP_CTRLSTAT_CDBGRSTREQ_BITNUM)
#define SWD_DP_CTRLSTAT_CDBGRSTACK           ((unsigned int)1 << SWD_DP_CTRLSTAT_CDBGRSTACK_BITNUM)
#define SWD_DP_CTRLSTAT_CDBGPWRUPREQ         ((unsigned int)1 << SWD_DP_CTRLSTAT_CDBGPWRUPREQ_BITNUM)
#define SWD_DP_CTRLSTAT_CDBGPWRUPACK         ((unsigned int)1 << SWD_DP_CTRLSTAT_CDBGPWRUPACK_BITNUM)
#define SWD_DP_CTRLSTAT_CSYSPWRUPREQ         ((unsigned int)1 << SWD_DP_CTRLSTAT_CSYSPWRUPREQ_BITNUM)
#define SWD_DP_CTRLSTAT_CSYSPWRUPACK         ((unsigned int)1 << SWD_DP_CTRLSTAT_CSYSPWRUPACK_BITNUM)
...
#define SWD_DP_SELECT_APBANKSEL        ((unsigned int)0x0F << SWD_DP_SELECT_APBANKSEL_BITNUM)
...
static const unsigned char SWD_CMD_SWDPRESET[] = {0x00,0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}; 
/// Switches DAP from JTAG to SWD. 
static const unsigned char SWD_CMD_JTAG2SWD[]  = {0x9e, 0xe7,0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};

static const unsigned char TEST[]  = {0xff, 0x00};
/// Switches DAP from SWD to JTAG.
static const unsigned char SWD_CMD_SWD2JTAG[]  = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x3c, 0xe7};
...
//sda in out change
#define  swd_output()       (gpio_mode_setup(GPIO_SWD_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_PULLUP, GPIO_SWD_SDA))
#define  swd_input()         (gpio_mode_setup(GPIO_SWD_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_SWD_SDA))
