...
#define FALSH_BLE_BOOTW_SIZE (384 * 1024) //sect 9 10 11
...
#define FLASH_APP_LEN (FLASH_TOTAL_SIZE - (FLASH_APP_START - FLASH_ORIGIN) - FALSH_BLE_BOOTW_SIZE)

#define FLASH_BOOT_SECTOR_FIRST 11
#define FLASH_BOOT_SECTOR_LAST 11

#define FLASH_STORAGE_SECTOR_FIRST 2
#define FLASH_STORAGE_SECTOR_LAST 3

#define FLASH_CODE_SECTOR_FIRST 4
#define FLASH_CODE_SECTOR_LAST 8

#define FLASH_BLE_SECTOR_FIRST 9
